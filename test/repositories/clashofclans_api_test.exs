defmodule ClashOfClansSlackbot.Repositories.ClashApiTest do
  use ExUnit.Case
  import Mock
  ...
  test "should return UndefinedFunctionError if the clantag is missing" do
    assert_raise UndefinedFunctionError, fn ->
      ClashOfClansSlackbot.Repositories.ClashApi.poll_donations
    end
  end

  test "should return UndefinedFunctionError if the token is missing" do
    assert_raise UndefinedFunctionError, fn ->
      ClashOfClansSlackbot.Repositories.ClashApi.poll_donations('#C8000C0')
    end
  end

  test "should return the players in %Player format" do
    with_mock HTTPotion, [get: fn("https://api.clashofclans.com/v1/clans/%23C8000C0/members", _headers) -> @clashapi_success_stub end,
      ...
      players = ClashOfClansSlackbot.Repositories.ClashApi.poll_donations("#C8000C0", "sometoken")
      assert {:ok, expected} == players
    end
  end
end
