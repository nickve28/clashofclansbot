defmodule Clashcaller.RequestTest do
 ...
 status_code: 200}
  ...
  test "construct reservations list" do
    assert Clashcaller.Request.construct("1234") === { :ok ,[REQUEST: "GET_FULL_UPDATE", warcode: "1234"] }
  end
  ...
  test "get overview" do
    with_mock HTTPotion, [post: fn(_url, _headers) -> @mock_clashcaller_reversations_success end] do
      ...
      assert Clashcaller.overview(params) === { :ok, @mock_clashcaller_reversations_success.body }
    end
  end
end
